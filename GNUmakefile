...
# markdown checked by markdownlint and lychee: website docs, README, contributing docs,
# and the .github markdown (PR/issue templates etc). The resource/data-source docs are
# exempt from markdownlint (leading \#) as they will soon be generated; links are still checked.
